<div class="col-md-2">
  <div class="list-group">
    ...
    <a class="list-group-item content" data-href="web/Tools_Support/UploadTournamentResults.html">Upload Tournament Data</a>
    <a class="list-group-item content" href="web/files/ASL Player Ratings Game Results Data Form.xlsx">Download Data Entry Form</a>
    <a class="list-group-item content" data-href="web/PHP/Tools/DownloadPlayerList.php">Download Player List</a>
