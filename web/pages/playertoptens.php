                ...
                <div class="tableFixHead">
                    <table class="table table-sm table-striped table-hover">
                        ...
                        <?php while ($row = $stmt->fetch()) {
                            ...
                            ?>
                            <tr>
                                <td><a class="content" href="tablePlayerGameResults.php?playercode=<?php echo $pnc ?>"><?php echo prettyname($name) ?></a></td>
