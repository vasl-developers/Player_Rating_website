...
$sql = "select m.Player1_Namecode, m.Player1_AttDef, m.Player1_AlliesAxis, m.Player1_Result, m.Player2_Namecode, m.Player2_AttDef, m.Player2_AlliesAxis, m.Round_No, m.Scenario_ID, p1.Fullname, p1.Hidden, p2.Fullname, p2.Hidden, s.name from match_results m
...
if ($stmt = $mysqli->prepare($sql)) {
	$stmt->execute();
	$stmt->bind_result($p1Code, $p1AttDef, $p1AlliAxis, $p1Result, $p2Code, $p2AttDef, $p2AlliAxis, $roundNo, $scenario, $player1, $play1hide, $player2, $play2hide, $scenName);
...
if ($player2 == "Hidden") {
      ...
      <td><a class="content" href="tableScenarioresults.php?scenarioid=<?php echo $scenario ?>">
          <?php echo $scenario . ' ' . $scenName ?></a></td>
    </tr>
    <?php
}
	?>
